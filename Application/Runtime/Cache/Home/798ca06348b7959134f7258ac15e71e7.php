...
<div class="main">
    ...
    <div class="">
        <div class="mleft">
           <h4 class="news-title"><?php echo ($info[0]['title']); ?></h4>
            <div class="msgbar">
                发布时间： <?php echo ($info[0]['time']); ?> 来源：<?php echo ($info[0]['source']); ?> 浏览次数：
                <span id="views"><?php echo ($info[0]['views']); ?></span>
            </div>
           <div class="news-content">
              <p>
                <pre><div><?php echo ($info[0]['content']); ?></div></pre>
              </p>
           </div>
        </div>
        <div class="mright">
