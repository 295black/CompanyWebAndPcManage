...
<div class="page-container">
  ...
  <div class="page-content">
    ...
    <div class="container-fluid">
        <h3 class="page-title">新闻修改</h3>
        <form action="/home/admin/news_update" method="post">
            <div class="formbox">
                <div class="formbox-title">新闻title</div>
                <div class="formbox-body">
                    <input style="height:51px;width:449px"type="text" name="title" value="<?php echo ($notice[0]['title']); ?>">
                </div>
            </div>
            <div class="formbox">
                <div class="formbox-title">新闻内容</div>
                <div class="formbox-body">
                    <textarea name="content"style="height:51px;width:449px"><?php echo ($notice[0]['content']); ?></textarea>
                </div>
            </div>
            <div class="formbox">
                <div class="formbox-title">新闻来源</div>
                <div class="formbox-body">
                    <input type="text" name="source" value="<?php echo ($notice[0]['source']); ?>">
                </div>
            </div>
             <div class="formbox">
