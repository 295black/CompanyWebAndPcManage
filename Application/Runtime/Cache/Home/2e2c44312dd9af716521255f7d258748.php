...
<div class="page-container">
  ...
  <div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <!--新增按钮-->
        <a href="/home/admin/projects_add" class="plus">新增<i class="icon-plus"></i></a>
        <div class="portlet box green">
            <table class="table table-striped">
                ...
                <tbody>
                <?php
 foreach ($projects_list as $value) { echo "<tr>"; echo "<td>".$value['id']."</td>"; echo "<td>".$value['name']."</td>"; echo "<td>".$value['director']."</td>"; echo "<td>".$value['source']."</td>"; echo "<td>".$value['amount']."</td>"; echo "<td>".$value['content']."</td>"; echo "<td><a class='table-caozuo look' href='/home/admin/projects_show?id=".$value["id"]."'>查看</a>"; echo "<a class='table-caozuo look' href='/home/admin/projects_edit?id=".$value["id"]."'>修改</a>"; echo "<a class='table-caozuo look' onclick='del_act(".$value['id'].")' href='#'>删除</a>"; echo "</td>"; echo "</tr>"; } ?>
                </tbody>
            </table>
        </div>
    </div>
    <script type="text/javascript">
        function del_act(id){
            if(confirm('确定删除？')){
                window.location.href="/home/admin/projects_delete?id="+id;
            }
        }
    </script>
