...
<div class="page-container">
  ...
  <div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <!--新增按钮-->
        <a href="/home/admin/notice_add" class="plus">新增<i class="icon-plus"></i></a>
        <div class="portlet box green">
            <table class="table table-striped">
                ...
                <tbody>
                <?php
 foreach ($notices_list as $value) { echo "<tr>"; echo "<td>".$value['nid']."</td>"; echo "<td>".$value['title']."</td>"; echo "<td>".$value['content']."</td>"; echo "<td>".$value['views']."</td>"; echo "<td>".$value['source']."</td>"; echo "<td>".$value['time']."</td>"; echo "<td><a class='table-caozuo look' href='/home/admin/notice_show?nid=".$value["nid"]."'>查看</a>"; echo "<a class='table-caozuo look' href='/home/admin/notice_edit?nid=".$value["nid"]."'>修改</a>"; echo "<a class='table-caozuo look' onclick='del_act(".$value['nid'].")' href='#'>删除</a>"; echo "</td>"; echo "</tr>"; } ?>
                </tbody>
            </table>
        </div>
    </div>
    <script type="text/javascript">
        function del_act(id){
            if(confirm('确定删除？')){
                window.location.href="/home/admin/notice_delete?nid="+id;
            }
        }
    </script>
